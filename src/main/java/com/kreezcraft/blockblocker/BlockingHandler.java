...
public class BlockingHandler {
    ...
    public static void load(WorldEvent.Load event) {
        int i = 0;
        while (i < BlockConfig.dontHarvest.size()) {
            String string = BlockConfig.dontHarvest.get(i);
        //        for(String string : BlockConfig.dontHarvest){
        ...
        for(String string : BlockConfig.dontPlace){
            String[] tmp = string.split("\\$");
        ...
        for(String string : BlockConfig.dontInteract){
            String[] tmp = string.split("\\$");
    ...
    public static RightClickBlock foxFire(RightClickBlock event) {
        ...
        if (event.getPlayer().getPosition() == target) {
            return event;
        }
